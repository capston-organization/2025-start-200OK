...
| **무엇을 만들고자 하는가** | - RPG 전투 시스템과 문제 풀이를 결합한 교육용 게임 플랫폼 <br> - 교사를 위한 퀘스트 제작 툴과 실시간 대시보드 제공 <br> - AI 기반 자동 문제 생성 및 학생 활동 분석으로 맞춤형 학습 경험 제공 <br> - 학생과 교사 모두에게 학습 상황을 직관적으로 보여주는 웹 서비스 |
| **고객** | 초·중등 학생 및 해당 학생들을 가르치는 교육자 |
| **Pain Point** | ① 학생들이 단순 문제 풀이에 흥미를 느끼지 못함 <br> ② 교사의 수업 준비 및 문제 제작 부담이 큼 <br> ③ 학급·학생별 학습 현황을 실시간으로 파악하기 어려움 <br> ④ 학생별 수준에 맞는 맞춤형 학습 제공이 부족 |
